...
function parsePredicate(key, value, isJoin) {

  var result = {};
  if(isKeyPair(key, value)) {
    result.parsed = parseKeyPair(key, value, isJoin)
...
function parseKeyPair(key, value, isJoin) {
