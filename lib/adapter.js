  ...
  var adapter = {
     ...
     */
     registerConnection: function(connection, collections, cb) {
       ...
       //wrap collections
       _.forEach(collections, function(collection, index){
          var iCollection = new Collection(collection);
          iCollections[collection.identity] = iCollection;
       });

      // Keep a reference to this collection
      var cinstance = new Connection(connection, iCollections);
    ...
    define: function(connectionName, collectionName, definition, cb) {
      ...
      console.log('Defining this...............', collection);
